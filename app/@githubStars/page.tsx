...
export default async function GitHubStarsPage() {
  ...
  return (
    <a
      ...
      aria-label={`Star env-typegen on GitHub — ${stars} ${stars === 1 ? "star" : "stars"}`}
      className="fixed bottom-6 right-6 z-50 flex items-center gap-1.5 rounded-full border border-[--border] bg-[--background] px-3 py-1.5 text-sm font-medium shadow-md transition-colors hover:bg-[--muted]"
    >
      {/* GitHub mark icon — MIT licensed, github.com/logos */}
      <svg
        aria-hidden="true"
        height="16"
        viewBox="0 0 16 16"
