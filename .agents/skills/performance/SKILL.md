...
```bash
# Lighthouse CLI
pnpm dlx lighthouse https://example.com --output html --output-path report.html
...
For Core Web Vitals specific optimizations, refer to the Core Web Vitals documentation.
