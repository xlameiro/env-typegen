...
> **Canonical spec**: [agentskills.io](https://agentskills.io) — the official specification for skill files. Consult it for valid frontmatter fields, description patterns, and bundled resource conventions before writing a new skill.
