...
| --------------------------------- | ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| `README.md`                       | **Example** — template README                   | Replace with your project's README — `pnpm clean:examples` writes a minimal stub; the `/new-project` prompt generates real content         |
| `package.json`                    | **Scaffold** (partially example)                | Keep; `pnpm clean:examples` sets `"name": "your-project-name"` — update `name`, `description`, `repository`, and `author` for your project |
...
| `app/icon.tsx`                    | **Example** — favicon with hardcoded "N" letter | Replace the letter and `stopColor` values to match your brand                                                                              |
...
| `public/.well-known/security.txt` | **Example** — placeholder security contact      | Update `Contact` email and `Policy` URL via the `/new-project` prompt (Step 7)                                                             |
| `CONTRIBUTING.md`                 | **Scaffold**                                    | Keep; update the `<repo-url>` placeholder with your real repository URL                                                                    |
| `SECURITY.md`                     | **Scaffold**                                    | Keep as-is — generic policy suitable for most projects                                                                                     |
