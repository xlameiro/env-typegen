...
| Parallel routes, intercepting routes, `@slot` convention, deep-link modals | `.github/instructions/nextjs.instructions.md` (§ 12) + `.agents/skills/nextjs-app-router-patterns/SKILL.md` (Pattern 4 & 5) |
...
| `app/@*/` (parallel route slots)            | `.github/instructions/nextjs.instructions.md` (§ 12) + `.agents/skills/nextjs-app-router-patterns/SKILL.md` |
