...
applyTo: ".github/instructions/code-review-generic.instructions.md"
excludeAgent: ["coding-agent"]
---

<!-- Template reference only — not loaded in Copilot context.
     The active project-specific reviewer is .github/agents/code-reviewer.agent.md.
     To use this template, copy it and set a proper applyTo pattern. -->
