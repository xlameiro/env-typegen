...
- **Does it need authentication?** (should it be protected by middleware)
...
4. **Metadata**: always define `export async function generateMetadata()` returning title, description.
...
export default function SettingsLoading() {
  return <div className="animate-pulse" aria-busy="true" aria-label="Loading settings" />
}
```
