...
const eslintConfig = defineConfig([
  ...
  globalIgnores([
    ...
    // QA test fixtures, outputs, and scripts — not application code, not linted by root config
    "qa-test/**",
    // Auto-generated by fumadocs-mdx — not authored code, should not be linted
    ".source/**",
  ]),
